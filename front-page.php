...
<div id="content" class="site-content">
    <div id="primay" class="content-area">
            ...
            <section class="services">
                ...
                <div class="container">
                    <div class="services-item">
                        <?php
                        if(is-active_sidebar('services-1')) {
                    ...
                    <div class="services-item">
                        <?php
                        if(is-active_sidebar('services-2')) {
                    ...
                    <div class="services-item">
                        <?php
                        if(is-active_sidebar('services-3')) {
                ...
                <div class="container">
                    ...
                    if()$postlist->have_posts()(
                        while($postlist->have_posts()) {
                           get_template_part('parts/contetnt','latest-news');
                        }
                    endwhile;
                    wp_reset_postdata();
                else:
                    ?>
                    <p>Nothing to be displayd</p>
                    <?php endif; ?>
                </div>
            </section>
        </main>
